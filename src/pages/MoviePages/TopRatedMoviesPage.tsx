...
const TopRatedMoviesPage = () => {
    ...
    const getTopRated=async()=>{
        setLoading(true);
        let topRated = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=${pageNumber}`);
  ...
  return (
    <div>
        ...
        <NavBar placeHolder={"Search For Movies..."} path={"/movies/search/"} />
                <Heading>
                    <span>Top Rated Movies</span> Results
                </Heading>
                {loading && <SearchResultsSkeleton movieName={'Top Rated Movies Result'} />}
                {!loading && (
                    <>
                        <CardWrapper>
                ...
                <ReactPaginate
                            ...
                            pageCount={TopRated.total_pages}
                            nextLabel="Next >"
