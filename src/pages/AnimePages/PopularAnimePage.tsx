...
const PopularAnimePage = () => {
    ...
    const getAnimeList=async()=>{
        setLoading(true);
        window.scrollTo(0,0);
        let result = await axios.get(`https://redux-api-wine.vercel.app/api/popular?page=${pageNumber}&count=${perPageitems}`);
  ...
  return (
    <div>
        <MainDiv>
            ...
            <Heading>
                    <p><span>Popular Anime Page {pageNumber}</span> Results</p>
                    <div>
                        <span>
                            Per Page
                        </span>
            ...
            {Loading && <SearchResultsSkeleton movieName={'Popular Anime Results'} />}
            ...
            {!Loading && (
                ...
                <div className='pagination'>
                    <Link onClick={()=>{
                        ...
                        return;
                        }}  to={ pageNumber > 1 ?  `/animes/popular&page=${pageNumber-1}` : `/animes/popular&page=${pageNumber}`}>
                        {"PREV"}
                    </Link>
                    ...
                    <Link onClick={()=>setPageNumber(pageNumber+1)}  to={`/animes/popular&page=${pageNumber+1}`}>
                        {"NEXT"}
                    </Link>
                </div>
        </MainDiv>
