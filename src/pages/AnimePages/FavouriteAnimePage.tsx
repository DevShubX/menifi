...
const FavouriteAnimePage = () => {
    ...
    const getAnimeList=async()=>{
        setLoading(true);
        window.scrollTo(0,0);
        let result = await axios.get(`https://redux-api-wine.vercel.app/api/favourite?page=${pageNumber}&count=${perPageitems}`);
  ...
  return (
    <div>
        <MainDiv>
            ...
            <Heading>
                    <p><span>Favourite Anime Page {pageNumber}</span> Results</p>
                    <div>
                        <span>
                            Per Page
                        </span>
            ...
            {Loading && <SearchResultsSkeleton movieName={'Favourite Anime Results'} />}
            ...
            {!Loading && (
                ...
                <div className='pagination'>
                    <Link onClick={()=>{
                        ...
                        return;
                        }}  to={ pageNumber > 1 ?  `/animes/favourite&page=${pageNumber-1}` : `/animes/favourite&page=${pageNumber}`}>
                        {"PREV"}
                    </Link>
                    ...
                    <Link onClick={()=>setPageNumber(pageNumber+1)}  to={`/animes/favourite&page=${pageNumber+1}`}>
                        {"NEXT"}
                    </Link>
                </div>
        </MainDiv>
