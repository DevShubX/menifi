...
const PopularIssues = () => {
    ...
    const [PopularIssues,setPopularIssues] = useState<any>([]);
    useEffect(()=>{
        getPopularIssues();
    },[]);
    const getPopularIssues =async()=>{
        let pop_comics = await axios.get("https://comics-api-wine.vercel.app/api/issues/");
        setPopularIssues(pop_comics.data);
        setLoading(false);
    }
  return (
    <div>
        ...
        {!loading && (
          ...
          >
            {PopularIssues.map((item:any,index:any)=>(
