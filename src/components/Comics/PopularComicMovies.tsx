...
const PopularComicMovies = () => {
    ...
    const getPopularMovies=async()=>{
        let pop_comics = await axios.get("https://comics-api-wine.vercel.app/api/movies/");
        setpopularMovies(pop_comics.data);
        setLoading(false);
    }
    return (
        <div>
...
export default PopularComicMovies