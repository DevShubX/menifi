...
const TvPopular = () => {
    ...
    const getPopularTVShows = async () => {
        let pop_tv = await axios.get(`https://api.themoviedb.org/3/tv/popular?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`);
        setPopularTvShows(pop_tv.data.results);
        setLoading(false);
    }
