...
const TvShowTrending = () => {
    ...
    const getTrendingTv = async () => {
        let trending_tv = await axios.get(`https://api.themoviedb.org/3/trending/tv/week?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`);
        setTrendingTv(trending_tv.data.results);
        setLoading(false);
    }
        ...
        <div>
            <MainDiv>
                <Heading>
                    ...
                    <Link to={"/tvshows/trending_tvshows"}>
                        View More
                    </Link>
                </Heading>
                ...
                {!loading && (
                    ...
                    >
                        {trendingTv.map((item: any, index: any) => (
