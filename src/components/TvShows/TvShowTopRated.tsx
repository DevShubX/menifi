...
const TvShowTopRated = () => {
    ...
    const getTopRatedTv = async()=>{
        let top_tv = await axios.get(`https://api.themoviedb.org/3/tv/top_rated?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`);
        setTopRatedTv(top_tv.data.results);
        setLoading(false);
    }
    ...
    <div>
        <MainDiv>
                ...
                {!loading && (
                    ...
                    >
                        {topRatedTv.map((item: any, index: any) => (
