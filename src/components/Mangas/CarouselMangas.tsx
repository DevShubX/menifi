...
const CarouselMangas = () => {
    ...
    const getCarouselMangas=async()=>{
        let result = await axios.get(`https://redux-api-wine.vercel.app/api/trending/manga?page=1&count=20`);
      ...
      <MainDiv>
              <Heading>
                ...
                {!loading && (
                    ...
                    >
                        {mangas.map((item: any, index: any) => (item.bannerImage !== null || undefined || "") && (
                                    ...
                                    <Wrapper>
                                        <Content>
                                            ...
                                            <p>
                                                ...
                                                Volumes : {item.volumes !== null || undefined ? item.volumes : "N/A"}
                                            </p>
                                            <p className='desc'>
                                                {
                                            ...
                                            <Button to={"/mangas/search/" + (item.title.userPreferred !== null || undefined || "" ? item.title.userPreferred : item.title.romaji !== null || undefined || "" ? item.title.romaji : item.title.english)}>
                                                <button>
                                                    <p>
                                                        Read Now
                                                    </p>
                                                    <BsArrowRight className='next-icon' />
                                                </button>
                                            </Button>
                                        </Content>
                                    </Wrapper>
