...
const UpcomingMoviesSlider = () => {
    ...
    const getUpComingMovies=async()=>{
        let upcoming = await axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`)
    ...
    <div>
        <MainDiv>
                ...
                {!loading && (
                    ...
                    >
                        {upcomingMovies.map((item: any, index: any) => (
