...
const TopRatedMoviesSlider = () => {
    ...
    const getTopRatedMovies=async()=>{
        let toprated = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`)
    ...
    <div>
        <MainDiv>
                ...
                {!loading && (
                    ...
                    >
                        {topRated.map((item: any, index: any) => (
