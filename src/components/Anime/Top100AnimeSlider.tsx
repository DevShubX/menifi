...
const Top100AnimeSlider = () => {
    ...
    const getTop100Anime = async () => {
        setLoading(true);
        let result = await axios.get(`https://redux-api-wine.vercel.app/api/top100?page=1&count=20`);
        setTop100Anime(result.data.data.Page.media);
        setLoading(false);
    }
        ...
        <div>
            <MainDiv>
                ...
                {!loading && (
                    ...
                    >
                        {top100anime.map((item: any, index: any) => (item.coverImage.large !== null || undefined || "") && (
