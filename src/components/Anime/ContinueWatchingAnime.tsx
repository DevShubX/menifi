...
const ContinueWatchingAnime = () => {
    ...
    const dbref = ref(database, `users/${currentUser.uid}/continueWatching/animes/animes_arr`);
    useEffect(()=>{
         ...
         <MainDiv>
            {animeArr.length > 0 && (
                <div>
                    ...
                    >
                        {animeArr.map((item: any, index: any) => (
                            <SwiperSlide>
                                <Content>
                                    <Wrapper>
                                        <Link to={(item.StreamingLink !== undefined)?item.StreamingLink:item.StreamingLink}>
                                            <img src={item.anilistPoster.large} alt="" />
                                        </Link>
...
const MainDiv = styled.div`
    margin-left:2rem;
`
export default ContinueWatchingAnime