...
interface AnimeStaffSectionProps{
    staff : any;
}

const AnimeStaffSection = ({staff}:AnimeStaffSectionProps) => {
  return (
    <MainDiv>
        <Heading>
            Staff
        ...
        <div className="grid-wrap">
            {staff?.edges?.map((staff:any,index:any)=>{
                return (
                    <div className="staff">
                        <div className="cover">
...
export default AnimeStaffSection